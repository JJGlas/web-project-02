---
sidebar_position: 5
description: "Software (CPU-based) Encoding of VVC with libvvenc. Main tool(s) used: FFmpeg." 
---
...
3. The following encoding command is a starting point that provides high-quality encoding for most videos, preserving detail efficiently while keeping encoding time reasonable and synthesizes the original look of film grain from the source:
