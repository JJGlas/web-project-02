...
For including and excluding different audio tracks, subtitles, setting track defaults, chapter files, and editing additional metadata, I like to use MKVToolNix GUI.
