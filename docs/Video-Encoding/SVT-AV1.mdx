...
| **Smoothing** | **Smart.** Cleans noise but keeps "energy" via AC-Bias. | **Extreme.** Scrubs grain to boost math scores. | **Low.** Keeps grain sharp (causes bitrate bloat). | **Moderate.** Better structure than Tune 2. |
