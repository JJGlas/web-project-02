...
1. Ensure you already have installed Av1an and/or FFmpeg and understand basic usage. If not, read: [Tool Installation & Preparation](/Video-Encoding/Tool-Installation-&-Preparation).

2. Av1an chunked encoding is faster than FFmpeg encoding so it is recommended. [FFmpeg SVT-AV1 encoding](#1) is shown further down the page. The following encoding command is a starting point that provides high-quality encoding for most videos, preserving detail efficiently while keeping encoding time reasonable:
...
### Encoding SVT-AV1 with FFmpeg Only {#1}
<details>
