...
<details>
  ...
  The same encoding command that is explained above, but excluding Av1an and only uses FFmpeg.
  This method of encoding is not chunked parallel encoding like Av1an, and therefore much slower. But atleast installation and getting started is a breeze.
