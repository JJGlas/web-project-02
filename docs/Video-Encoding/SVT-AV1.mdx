...
| **Community Use** | **Standard.** The go-to for all video. | *Scientific Testing.** Use primarily by developers for apples to apples benchmark comparisons. Don't use it if your after visual qulaity as it turns off those psychovisual features to satisfy a math equation. | **Niche.** Used for maximum space saving. | **Avoid.** Primarily for photos, not video. | **Experimental.** 5–8% more efficient than the older, Tune 2. Removing noise while keeping edges sharp. |
